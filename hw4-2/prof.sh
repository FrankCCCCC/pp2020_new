...
do
    ...
    do
        ...
        echo -e "srun -p prof -N1 -n1 --gres=gpu:1 nvprof -f -o ${prof_file} ${target} /home/pp20/share/hw4-1/cases/${tc} ./out/${out} ${bs} ${dim_x} ${dim_y}"
        ...
        srun -p prof -N1 -n1 --gres=gpu:1 nvprof -f -o ${prof_file} ${target} /home/pp20/share/hw4-1/cases/${tc} ./out/${out} ${bs} ${dim_x} ${dim_y}
        echo -e "-----------------------\n" >> prof_f.txt
