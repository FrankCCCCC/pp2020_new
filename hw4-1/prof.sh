...
echo -e "Compiling..."
nvcc -O3 -std=c++11 -Xptxas=-v -arch=sm_61  -lm ./prof/hw4-1.cu -o ./execs/hw4-1_prof
...
do
    ...
    do
        ...
        ${runner} nvprof -o ./prof/prof.nvvp ./execs/hw4-1 /home/pp20/share/hw4-1/cases/c21.1 ./out/c21.1
        ...
        echo -e "${runner} nvprof --metrics ${met} ${target} /home/pp20/share/hw4-1/cases/${tc} ./out/${out} ${bs} ${dim_x} ${dim_y}"
        # ${runner} nvprof --metrics ${met} ${target} /home/pp20/share/hw4-1/cases/${tc} ./out/${out} ${bs} ${dim_x} ${dim_y}
        echo -e "-----------------------\n" >> prof_f.txt
